  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Payment <em style={{ color: "#FF6B00", fontStyle: "italic" }}>Cancelled</em>
        </h1>
        <p
          style={{
            fontSize: "0.95rem",
        ...
        >
          Your registration was not completed. No worries — you can return to the form and
          restart your Walk-A-Thon registration anytime.
        </p>
      </section>
        ...
        >
          <div
            style={{
              ...
              margin: "0 auto 18px",
              borderRadius: "50%",
              background: "linear-gradient(135deg, #FFF3E8, #FFE0C4)",
              display: "flex",
              alignItems: "center",
          ...
          >
            It looks like the payment process was cancelled before completion. Your spot has
            not been reserved yet, and no confirmation email or QR code was sent.
          </p>
          ...
          >
            ...
            <div style={{ color: "#5C4033", fontSize: "0.92rem", lineHeight: 1.7 }}>
              • Click the button below to return home and restart registration.<br />
              • Fill in your details again and proceed to secure checkout.<br />
              • Once payment is successful, you will receive your QR confirmation and receipt by email.
            </div>
          </div>
